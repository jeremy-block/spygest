...
levels(gathered_metrics2$Level) <- c("No Aud.", "Self", "Peer", "Manager", "No Exp.", "Manual", "Man.Masked", "Temp.Masked")
gathered_metrics2$Level <- factor(gathered_metrics2$Level, levels = c("No Aud.", "Self", "Peer", "Manager", "No Exp.", "Manual", "Man.Masked", "Temp.Masked"))
gathered_metrics2 %>%
...
factuality <- factuality %>%
  ...
  select(`Participant Number`, `Repeated Phrase`, `Content Verifiability Errors`, `Discourse Errors`, `Semantic Frame Errors`)
